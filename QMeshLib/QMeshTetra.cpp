...
//	//		return NULL;
//	//}
//	if (whichNode == 1) return faces[0]->GetNodeRecordPtr(0);
//	if (whichNode == 2) return faces[0]->GetNodeRecordPtr(1);
//	if (whichNode == 3) return faces[0]->GetNodeRecordPtr(2);
//	if (whichNode == 4) return faces[1]->GetNodeRecordPtr(1);
//}
