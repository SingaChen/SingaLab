...
public:
	...
	//Topology optimization para
	double rVol = 1; //volume difference ratios
	double ARAPenergy = 0.0; //install ARAP energy
	double dense = 1.0; //install density (by sensitivity analysis)
	bool isPeel = false; //peeled tetra
	int topopt_index = -1; //for sensitivity analysis sorting
